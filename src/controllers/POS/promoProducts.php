...
// =======================================================
// =     Fetching of Promo Products - Starts Here      =
// =======================================================

// Class PromoMenu extends Dbh to access database connection methods
class PromoMenu extends Dbh
{
    // -------------------------------------------------------
    ...
    {
        // --------------------------------------------------------------------------
        // - SQL query selects product details for 'promo' size Promo products   -
        // --------------------------------------------------------------------------
        $sql = "
...
// Instantiate the PromoMenu class and fetch products
$menu = new PromoMenu();
$products = $menu->getPromoProducts();

// =======================================================
// =      Fetching of Promo Products - Ends Here       =
// =======================================================
