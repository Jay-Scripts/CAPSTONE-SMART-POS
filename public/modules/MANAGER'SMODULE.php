...
<body class="bg-[var(--background-color)]">
  ...
  <section id="stockEntry" class="bg-[var(--background-color)] text-[var(--text-color)] rounded-lg shadow p-6">
    ...
    <!-- Inventory Form -->
    <form id="inventoryForm" enctype="multipart/form-data" class="space-y-8 bg-[var(--background-color)] text-[var(--text-color)] border border-[var(--border-color)] p-8 rounded-xl shadow-lg max-w-2xl mx-auto">
    ...
    <script>
      ...
      document.getElementById('inventoryFile').addEventListener('change', function() {
        ...
        // ✅ Validate Excel format (check sheet names and headers)
