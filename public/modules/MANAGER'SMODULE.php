...
<body class="bg-[var(--background-color)]">
  ...
  <section id="stockEntry" class="bg-[var(--background-color)] text-[var(--text-color)] rounded-lg shadow p-6">
    ...
    <script>
      ...
      // 📤 Submit Inventory (does not block other forms)
      document.getElementById('submitInventory').addEventListener('click', function() {
        const fileInput = document.getElementById('inventoryFile'); // ✅ Correct target
        ...
        reader.readAsArrayBuffer(fileInput.files[0]); // ✅ Correctly reads the file now
      });
    </script>
